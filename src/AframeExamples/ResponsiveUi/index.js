import 'aframe'
import { highlight, infoPanel } from './components'
function ResponsiveUi() {
  return (
    <a-scene
      ...
      <a-entity
        position="-0.110 1.000 0.300"
        scale="1.000 1.000 1.000"
        light="type:directional;shadowRadius:1.000;"
      ></a-entity>
      <a-entity id="environmentGround" position="0.000 0.000 0.000" rotation="-90.00 0.000 0.000" scale="1.000 1.000 3.000"></a-entity>
     
      <a-sky   color="#ECECEC" shader="skyshader" sunPosition="-0.104 0.944 0.422"></a-sky> 

      {/* <a-sky   
         reileigh="1.320"
         mieDirectionalG="0.800"
         color="#FFF" 
         luminance="0.800" 
         mieCoefficient="0.005" 
         shader="skyshader" 
         sunPosition="-0.104 0.944 0.422"
      ></a-sky>  */}
